...
```shell
pip install git+https://github.com/Latios96/py-typescript-generator.git@v0.3.0
```
or if you are using poetry:
```shell
poetry add git+ssh://git@github.com:Latios96/py-typescript-generator.git#v0.3.0
```
### Invocation
